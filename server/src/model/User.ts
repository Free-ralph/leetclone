...
import Profile ,{ ProfileInterface } from "./Profile.js";
import jwt from "jsonwebtoken";

interface UserMethods {
  CreateJWT(): { refresh: string; access: string };
...
const UserSchema = new mongoose.Schema<UserInterface, UserModel, UserMethods>({
  username: {
    type: String,
